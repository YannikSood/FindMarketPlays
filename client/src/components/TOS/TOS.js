    ...
    return (
      <Container>
        ...
        <p>
          ...
          website constitutes a solicitation, recommendation, endorsement, or any
          ...
          using the Site, you agree not to hold FindMarketPlays LLC, its affiliates
        ...
        <p>
          ...
          risk investments may use leverage, which will accentuate gains or
          ...
          in accounting methods. A security or firms past investment
          performance is not a guarantee or predictor of future investment
          performance.
        </p>
        <h3>Third Part Linked Sites</h3>
        <p>
          As a convenience to you, "FindMarketPlays LLC" may provide hyperlinks to
          web sites operated by third parties. When you select these hyperlinks
          you will be leaving the "FindMarketPlays LLC" site. Because
          "FindMarketPlays LLC" has no control over such sites or their content,
          "FindMarketPlays LLC" is not responsible for the availability of such
          external sites or their content, and "FindMarketPlays LLC" does not adopt,
          ...
          "FindMarketPlays LLC" does not endorse such sites and shall not be
          ...
          incurred in connection therewith. "FindMarketPlays LLC" may, in its sole
        ...
        <p>
          The "FindMarketPlays LLC" website utilizes different technologies to
          ...
          the "FindMarketPlays LLC" site require cookies to be enabled to enhance
        ...
        <p>
          ...
          "FindMarketPlays LLC" AND ITS EMPLOYEES, OFFICERS, DIRECTORS, , PARTNERS,
        ...
        <p>
          ...
          TO STOP USING THE SITE AND CONTENT. "FindMarketPlays LLC" IS NOT LIABLE
          ...
          INTANGIBLES. IN PARTICULAR, AND WITHOUT LIMITATION, "FindMarketPlays LLC"
        ...
        <p>
          ...
          property of "FindMarketPlays LLC" and is protected by copyright,
          ...
          expressly authorized in advance by "FindMarketPlays LLC" in writing, you
          ...
          "FindMarketPlays LLC" include, without limitation, "FindMarketPlays LLC" and
          any associated logos. All trademarks and service marks on the Site not
          owned by "FindMarketPlays LLC" are the property of their respective
          ...
          of "FindMarketPlays LLC"’s trade names, trademarks or service marks
          without our express prior written consent.
        </p>
        <h3>Termination</h3>
        <p>
          "FindMarketPlays LLC", in its sole discretion, may terminate your access
          ...
          without notice. "FindMarketPlays LLC" shall not be liable to you or any
        ...
        <p>
          ...
          to sell or buy any goods or services without "FindMarketPlays LLC"’s
          ...
          "FindMarketPlays LLC" express prior written consent. • Create a database
        ...
        <p>
          ...
          defend and hold harmless "FindMarketPlays LLC" (specifically including its
